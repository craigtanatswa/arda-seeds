  ...
  return (
    <div>
      <ProductHero
        ...
        image="/images/cowpea-hero.jpg"
      />

      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h2 className="text-2xl font-bold mb-4">About Our Cowpea Seeds</h2>
          <p className="text-gray-700 mb-4">
            ARDA Seeds offers superior cowpea varieties developed specifically for Zimbabwe's challenging growing conditions. 
            Our cowpea seeds combine early maturity with excellent disease resistance, particularly to cowpea aphids borne mosaic virus (CABMV), 
            providing farmers with reliable performance in regions III, IV & V.
          </p>
          <p className="text-gray-700">
            Cowpea is an important legume crop in Zimbabwe, valued for its high protein content, drought tolerance, 
        ...
        <div className="bg-green-50 p-6 rounded-lg mb-8">
          <h3 className="text-xl font-semibold mb-4">Benefits of Growing Cowpea</h3>
          <div className="grid md:grid-cols-2 gap-6">
            <ul className="space-y-2 text-gray-700">
              ...
              <li className="flex items-start">
                ...
                <span>High resistance to cowpea aphids borne mosaic virus (CABMV)</span>
              </li>
              <li className="flex items-start">
                <svg className="h-5 w-5 text-green-500 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
